...
\033[1;33m
 ____                                 _
|  _ \ _____      _____ _ __         | | __ _ _ __ ___
| |_) / _ \ \ /\ / / _ \ '__|____ _  | |/ _` | '_ ` _ \
|  __/ (_) \ V  V /  __/ | |_____| |_| | (_| | | | | | |
|_|   \___/ \_/\_/ \___|_|        \___/ \__,_|_| |_| |_|\033[1;91mv2.1
\033[1;36m =============================================\033[1;m
...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't install Power-Jam.\033[1;m
\033[1;31m  [ + ]  \033[1;31mThere are some errors.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again after later.\033[1;m''')
    self.tool_footer()
  ...
  def ins_tnc(self):
    self.tool_header()
    print ('''
\033[1;33m  [ + ] \033[1;32mUse It For Educational Purposes.
...
\033[1;31m If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print ('''
\033[1;33m    [ + ] \033[1;32mPower-Jam installed successfully.
\033[1;33m    [ + ] \033[1;32mTo run Power-Jam.
\033[1;33m    [ + ] \033[1;32mType Power-jam in your terminal.''')
    self.tool_footer()
...
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mPower-Jam Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't Update Power-Jam.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again later.\033[00m''')
    self.tool_footer()
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Tool Name :- \033[1;32mPower-Jam
\033[1;33m       [+] Creator :- \033[1;32mLesego Ruele
\033[1;33m       [+] Latest Update :- \033[1;32m11/7/2020.\033[1;m
\033[1;33m       [+] Tools :- \033[1;32mtotal {total} tools.\033[1;m
\033[1;33m [+] \033[1;32mPower-Jam is a tool which helps install other tools.
...
\033[1;31m [+] Note :- Use this tool at your own risk.''')
  ...
  def install_tools(self):
    print ("""\033[01;33m =============================================
\033[01;32m|_____________ Choose your tool ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ + ] \033[1;37m'{name}'\033[01;32m it has already been Installed !!
''')
    self.tool_footer()
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating Power-Jam ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ 2 ] \033[1;32mTool Category.
\033[1;33m  [ 3 ] \033[1;32mUpdate Power-Jam.
...
\033[1;33m  [ x ] \033[1;32mFor Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print ('''
\033[1;33m         [ + ] \033[1;32mThanks for using Power-Jam
\033[1;33m         [ + ] \033[1;32mBye Bye..... :)\033[00m''')
    self.tool_footer()