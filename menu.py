    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Power-Jam"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/DroidMa/Power-Jam.git "+system.home+"/Power-Jam")
            if os.path.exists(system.home+"/Power-Jam/install.aex"):
              os.system("cd "+system.home+"/Power-Jam && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Power-Jam"):
              ...
              os.system("git clone https://github.com/DroidMa/Power-Jam.git "+system.home+"/Power-Jam")
            if os.path.exists(system.home+"/Power-Jam/install.aex"):
              os.system("cd "+system.home+"/Power-Jam && sh install.aex")
              if os.path.exists(system.bin+"/Power-Jam") and os.path.exists(system.conf_dir+"/Power-Jam"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall Power-Jam" or cmd=="unistall Power-Jam":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Power-Jam")
          os.system(system.sudo+" rm -rf "+system.bin+"/Power-Jam")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Power-Jam")
        else:
          os.system("rm -rf "+system.bin+"/Power-Jam")
          os.system("rm -rf "+system.bin+"/Power-Jam")
          os.system("rm -rf "+system.conf_dir+"/Power-Jam")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Power-Jam/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Power-Jam/core/cat.json") as cat_file:
